...
FIGURES_DIR=figures/
FIGURES=$(addprefix ${FIGURES_DIR}, crystal_resonance.pdf dhips.pdf eli_np_logo.png gammasphere.jpg higs.pdf neutron_star_merger.jpg prism.jpg r_process_schematic.pdf se82_spectrum_branchings.pdf snm.pdf th229m.pdf)
