...
LATEX_SOURCE=$(addprefix ${LATEX_SOURCE_DIR}, $(addsuffix .tex, absorption_spectroscopy bremsstrahlung doppler_broadening footer quasimonochromatic resonance_fluorescence resonance_fluorescence_atom resonance_fluorescence_nucleus r_process scattering spectrum_summary title))
...
FIGURES_DIR=figures/
FIGURES=$(addprefix ${FIGURES_DIR}, crystal_resonance.pdf dhips.pdf eli_np_logo.png gammasphere.jpg higs.pdf neutron_star_merger.jpg prism.jpg r_process_schematic.pdf se82_spectrum_branchings.pdf th229m.pdf)
