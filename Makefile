...
LATEX_SOURCE=$(addprefix ${LATEX_SOURCE_DIR}, $(addsuffix .tex, footer resonance_fluorescence resonance_fluorescence_atom resonance_fluorescence_nucleus scattering title))
...
FIGURES_DIR=figures/
FIGURES=$(addprefix ${FIGURES_DIR}, prism.jpg)
